            ...
            <div className="bg-white rounded-2xl shadow-xl border border-cream-100 p-8">
              {envoye ? (
                <div className="text-center py-4">
                  ...
                  <h2 className="text-xl font-playfair font-bold text-brown-800 mb-2">
                    Email envoyé !
                  </h2>
                  ...
                  <Link
                    to="/connexion"
                    className="inline-flex items-center gap-2 text-terra-600 hover:text-terra-700 font-medium transition"
                  >
                    <FaArrowLeft />
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <FaEnvelope className="text-terra-400" />
                      </div>
                      <input
                        type="email"
                        value={email}
                  ...
                  <div className="text-center">
                    <Link
                      to="/connexion"
                      className="inline-flex items-center gap-2 text-terra-500 hover:text-terra-700 text-sm transition"
                    >
                      <FaArrowLeft />
                      Retour à la connexion
                    </Link>
