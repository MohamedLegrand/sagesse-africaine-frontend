...
const FormulaireOrangeMoney = ({ onSubmit, loading }) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="bg-amber-50 rounded-xl p-4 mb-4">
        <p className="text-amber-700 text-sm">
          Vous allez recevoir une notification sur votre téléphone Orange Money pour confirmer le paiement.
        </p>
      </div>
...
export default FormulaireOrangeMoney;